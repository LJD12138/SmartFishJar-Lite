...
{
    /* 确认键 PC13 */
    rcu_periph_clock_enable(keyGPIO_ENTER_RCU);
    gpio_init(keyGPIO_ENTER_PORT, GPIO_MODE_IPU, GPIO_OSPEED_2MHZ, keyGPIO_ENTER_PIN);

    /* 左键 PC14 */
    rcu_periph_clock_enable(keyGPIO_LEFT_RCU);
    gpio_init(keyGPIO_LEFT_PORT, GPIO_MODE_IPU, GPIO_OSPEED_2MHZ, keyGPIO_LEFT_PIN);

    /* 上键 PC15 */
    rcu_periph_clock_enable(keyGPIO_UP_RCU);
    gpio_init(keyGPIO_UP_PORT, GPIO_MODE_IPU, GPIO_OSPEED_2MHZ, keyGPIO_UP_PIN);

    /* 下键 PC12 */
    rcu_periph_clock_enable(keyGPIO_DOWN_RCU);
    gpio_init(keyGPIO_DOWN_PORT, GPIO_MODE_IPU, GPIO_OSPEED_2MHZ, keyGPIO_DOWN_PIN);

    /* 右键 PD2 */
    rcu_periph_clock_enable(keyGPIO_RIGHT_RCU);
    gpio_init(keyGPIO_RIGHT_PORT, GPIO_MODE_IPU, GPIO_OSPEED_2MHZ, keyGPIO_RIGHT_PIN);
